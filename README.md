# robosys2025
標準入力から指定された形式で入力された食べ物リストであるテキストファイルを読み込み、カロリーの合計を出力するコマンドです。また、カロリーが日本人男性の一日のカロリー摂取量の基準値である2650kcalを超えると赤色で値が出力されます。
# mkcon
...
![red text](https://via.placeholder.com/200x50/ff0000/ffffff?text=3080kcal)
